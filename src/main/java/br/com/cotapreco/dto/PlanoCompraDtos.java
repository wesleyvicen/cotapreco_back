...
public final class PlanoCompraDtos {
    ...
    public record SolicitacaoPlanoCompra(@NotEmpty List<@Valid ItemPlanoCompra> items,Long baseVersionId){
        public SolicitacaoPlanoCompra(List<ItemPlanoCompra> items){this(items,null);}
    }
