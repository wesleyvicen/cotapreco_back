...
public final class PedidoCompraDtos {
    ...
    public record SolicitacaoGeracaoPedido(@Size(max=500) String observation,boolean confirmBelowMinimum){}
    ...
    public record VisaoPedido(Long id,Long responseId,String number,StatusPedidoCompra status,String supplierName,
        String supplierDocument,BigDecimal total,BigDecimal minimumOrderValue,boolean belowMinimum,
        boolean belowMinimumConfirmed,Instant generatedAt,Instant sharedAt,boolean pdfAvailable,List<ItemPedido> items){}
}
